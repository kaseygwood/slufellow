...
```{r}
ggplot(data = course_app_semester, aes(x = term, y = semester_enrolled, label = semester_enrolled, group = 1)) +
          geom_line() +
          geom_point() +
...
course_app_semester <- left_join(course_app_semester, course_app_section3,
                                         by = c("term"))
plot1 <- ggplot(data = course_app_semester, aes(x = term, y = semester_enrolled, group = 1, label = total_sections)) +
          geom_line() +
          geom_point() +
          geom_point(data = course_app_section, aes(x = term, y = cumulative_enrolled, group = 1, label = section), alpha = 0.25, shape = 45)+
